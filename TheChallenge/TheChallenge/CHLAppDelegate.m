...
+ (void) initialize
{
    [SCSoundCloud setClientID:@"49f738b6e29c3b83f93e7cd81b20f624"
                  ...
                  redirectURL:[NSURL URLWithString:@"thechallenge://test"]];
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"TheChallenge" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"TheChallenge.sqlite"];
